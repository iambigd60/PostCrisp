  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-crisp mt-1">What&apos;s peaking, what&apos;s rising, and what&apos;s hot in your niche.</p>
      </div>
              ...
              <div key={i} className="rounded-xl border border-edge bg-surface-secondary p-4 hover:border-brand-400 transition-colors">
                <div className="flex items-start justify-between gap-2 mb-2">
                  ...
                  <div className="text-right flex-shrink-0">
                    ...
                    <div className="text-2xs text-crisp">virality</div>
                  </div>
                </div>
                ...
                <div className="space-y-2 pt-3 border-t border-edge">
                  <div>
                    <p className="text-2xs text-crisp uppercase tracking-wider mb-0.5">How to use it</p>
                    <p className="text-xs text-zinc-300">{t.howToUse}</p>
                  </div>
                  <div>
                    <p className="text-2xs text-crisp uppercase tracking-wider mb-0.5">Content angle</p>
